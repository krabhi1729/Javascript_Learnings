...
* let and const declarations are hoisted. But its different from **var**
    ...
    ```
  Hoisting Surprises: Both a and b are hoisted, initialized as undefined. However, the scope of a is different, causing a ReferenceError until assigned.  
...
* **Temporal Dead Zone** : The duration between hoisting and assigning a value to a let variable.
...
* **Let** is a stricter version of **var**. Now, **const** is even more stricter than **let**.
    A const declaration must be initialized immediately, and its value cannot be reassigned.
    ```js
    let a;
    a = 10;
