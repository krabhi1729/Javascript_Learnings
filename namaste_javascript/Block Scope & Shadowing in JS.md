...
Lexical scoping is a way to resolve variable names by looking at the structure of the code. It follows the nesting of blocks or functions. In simple terms, a variable defined in an outer scope is accessible in an inner scope, but not vice versa.
...
console.log(c); // 100
```
In this example, the inner function x can access its own c and the outer c. Lexical scoping ensures clarity in variable resolution.
